...
/**
 * This class holds files of foods
 * @author Melika
 * @since 2020
 */
public class FoodFile {
    private static final String CLASS_PATH = "./foods/";
   ...
   /* public static void fileWriter(String content) {
    ...
    public static void objectFileWriter(FoodModel foodModel){
        String fileName = CLASS_PATH + foodModel.getName() + foodModel.getDate();
        try {
            FileOutputStream fileOutputStream = new FileOutputStream(fileName);
            ObjectOutputStream objectOutputStream = new ObjectOutputStream(fileOutputStream);
            objectOutputStream.writeObject(foodModel);
    ...
    public static FoodModel objectFileReader(File file){
        FoodModel foodModel = null;
        try {
            FileInputStream fileInputStream = new FileInputStream(file);
            BufferedInputStream bufferedInputStream = new BufferedInputStream(fileInputStream);
            ObjectInputStream objectInputStream = new ObjectInputStream(bufferedInputStream);
            foodModel = (FoodModel) objectInputStream.readObject();
